module.exports = {
  sidebar: {
        ...
        "Solución": [
          'developers/solucion/arquitectura-overview',
          {
            "Descripción técnica": [
              ...
              'developers/solucion/descripcion-tecnica/arquitectura-verificador',
              "developers/solucion/descripcion-tecnica/arquitectura-ronda",
              'developers/solucion/descripcion-tecnica/arquitectura-aidi',
    ...
    "Changelog": [ 
      ...
      {"ai·di": ['changelog-aidi/v1.6.x','changelog-aidi/v1.5.x']},
    ],
  },
};
