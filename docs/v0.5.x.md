...
- [Blockchain Manager] Fix método revokeDelegate que no estaba expuesto. [#15](https://github.com/ong-bitcoin-argentina/DIDI-SSI-Blockchain-manager/pull/15)
- [Blockchain Manager] Versión v1.2.1 [#16](https://github.com/ong-bitcoin-argentina/DIDI-SSI-Blockchain-manager/pull/16)
