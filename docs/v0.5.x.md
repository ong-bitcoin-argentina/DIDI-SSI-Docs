...
### v0.5.16
**3/08/2021**
- [DIDI Server] Se corrigen nombres de algunos controladore de IssuerRoutes.
- [DIDI Server] Se agrega el imageId en cada issuer y la cantidad total de paginas para el endpoint /issuer/list
- [DIDI Server] Se corrigen errores varios.
- [DIDI Server] Se optimizan los lamados a la db en IssuerModel.
- Cambios realizados en el siguiente Pull Request [#173](https://github.com/ong-bitcoin-argentina/DIDI-SSI-Server/pull/173)
